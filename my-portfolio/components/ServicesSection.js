...
const servicesData = [
  {
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12 text-cyan-400 mb-4 mx-auto">
...
const ServiceCard = ({ service, index }) => {
  ...
  const handleMouseMove = (e) => {
    ...
    const rotateY = (x / rect.width - 0.5) * -25; // Tilt intensity
    const rotateX = (y / rect.height - 0.5) * 25; // Tilt intensity
  ...
  return (
    // This outer div handles the scroll-reveal animation
    <div
      ref={scrollRef}
    ...
    >
      ...
      <div
        ...
        className="bg-gray-800 text-center p-8 rounded-lg shadow-lg border border-gray-700"
      >
        {service.icon}
